...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument("--match_thres", type=float, default=0.8, help="matching threshold for tracking")
    self.parser.add_argument('--input-video', type=str,
                             default='../videos/MOT16-03.mp4',
                             help='path to the input video')
    self.parser.add_argument('--device', default='0', help='-1 for CPU, use comma for multiple gpus')
    self.parser.add_argument('--Global_Point', type=int, default=1, help='0 for global, 1 for point')
    self.parser.add_argument('--radius', type=int, default=3, help='radius for heatmap')
    self.parser.add_argument('--conf_thres_siammot', type=float, default=0.3, help='object confidence threshold')
    self.parser.add_argument('--iousfuse_thres', type=float, default=0.5, help='iou thresh for nms')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home1/liuqigui/project/dataset/MIX')
