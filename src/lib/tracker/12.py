...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        dists = matching.iou_distance(second_tracked_stracks, detections_second) #计算两个IOU距离
        matches, u_track, u_detection_second = matching.linear_assignment(dists, thresh=0.4) #匈牙利匹配
        for itracked, idet in matches:
